...
public class EditPosition extends JFrame {
	...
	public EditPosition(int id, int project_id, JFrame alien) {
		this.id = id;
	...
	private void initialize() {
		...
		editButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				dba.editPosition(id, title.getText(), startDate, endDate, pr, (int)idDepartment.getValue(), (int)idStaff.getValue() );
