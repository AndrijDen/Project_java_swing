...
public class EditProject extends JFrame {
	...
	public EditProject(int id, JFrame alien) {
		this.id = id;
		this.alien = alien;
		dba = new DbAccess();
	...
	private void initialize() {
		...
		name = new JTextField();
		name.setBounds(80, 18, 136, 20);
		contentPane.add(name);
		name.setColumns(10);
		
		owner = new JTextField();
		owner.setBounds(80, 71, 136, 20);
		...
		lblRealEndYear.setBounds(10, 171, 92, 14);
		...
		lblMark.setBounds(10, 221, 46, 14);
		contentPane.add(lblMark);
		
		mark = new JTextField();
		mark.setBounds(80, 218, 106, 20);
		...
		editButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				dba.editProject(id, name.getText(), (int)department_id.getValue(), owner.getText(), st, end, rend, pr, c, mark.getText());
